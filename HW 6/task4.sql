...
CREATE TABLE minizooKeeper (Staff_ID VARCHAR(6) PRIMARY KEY, Keeper_Name VARCHAR(20));
...
ALTER TABLE minizooCare_Role ADD PRIMARY KEY (ID);

select * from minizooAnimal;
show tables;
